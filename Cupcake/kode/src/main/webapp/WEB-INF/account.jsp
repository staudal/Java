          ...
          <form action="UpdateUserInfoServlet" method="post">
            <div class="row g-3">
              <div class="col-sm-6">
                ...
                <input type="text" class="form-control" id="firstName" value="${sessionScope.user.getFirstName()}" name="firstName" required>
              </div>

              <div class="col-sm-6">
                <label for="lastName" class="form-label">Last name</label>
                <input type="text" class="form-control" id="lastName" value="${sessionScope.user.getLastName()}" name="lastName" required>
              </div>

              <div class="col-12">
                <label for="username" class="form-label">Email</label>
                <div class="input-group">
                  <input type="text" class="form-control" id="username" value="${sessionScope.user.getEmail()}" name="email" required>
                </div>
              </div>

              <div class="col-12">
                <label for="address" class="form-label">Adgangskode</label>
                <input type="password" class="form-control" id="address" value="${sessionScope.user.getPassword()}" name="password" required>
              </div>
            ...
            <button class="w-100 btn btn-primary btn-lg mt-4" type="submit">Opdater oplysninger</button>
          </form>
        </div>
      </div>
    </main>
